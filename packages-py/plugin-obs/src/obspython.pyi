...
class gs_monitor_info:
    ...
    x: long = property(_obspython.gs_monitor_info_x_get, _obspython.gs_monitor_info_x_set, doc="x")
    y: long = property(_obspython.gs_monitor_info_y_get, _obspython.gs_monitor_info_y_set, doc="y")
    cx: long = property(_obspython.gs_monitor_info_cx_get, _obspython.gs_monitor_info_cx_set, doc="cx")
    cy: long = property(_obspython.gs_monitor_info_cy_get, _obspython.gs_monitor_info_cy_set, doc="cy")
...
class gs_vb_data:
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    num: size_t = property(_obspython.gs_vb_data_num_get, _obspython.gs_vb_data_num_set, doc="num")
    points: "struct vec3 *" = property(_obspython.gs_vb_data_points_get, _obspython.gs_vb_data_points_set, doc="points")
    ...
    colors: "uint32_t *" = property(_obspython.gs_vb_data_colors_get, _obspython.gs_vb_data_colors_set, doc="colors")
...
class gs_init_data:
    ...
    cx: uint32_t = property(_obspython.gs_init_data_cx_get, _obspython.gs_init_data_cx_set, doc="cx")
    cy: uint32_t = property(_obspython.gs_init_data_cy_get, _obspython.gs_init_data_cy_set, doc="cy")
...
class vec4:
    ...
    ptr: float[4] = property(_obspython.vec4_ptr_get, _obspython.vec4_ptr_set, doc="ptr")
...
class vec3:
    ...
    ptr: float[4] = property(_obspython.vec3_ptr_get, _obspython.vec3_ptr_set, doc="ptr")
...
class vec2:
    ...
    ptr: float[2] = property(_obspython.vec2_ptr_get, _obspython.vec2_ptr_set, doc="ptr")
...
class matrix4:
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    x: "struct vec4" = property(_obspython.matrix4_x_get, _obspython.matrix4_x_set, doc="x")
    y: "struct vec4" = property(_obspython.matrix4_y_get, _obspython.matrix4_y_set, doc="y")
    z: "struct vec4" = property(_obspython.matrix4_z_get, _obspython.matrix4_z_set, doc="z")
    t: "struct vec4" = property(_obspython.matrix4_t_get, _obspython.matrix4_t_set, doc="t")
...
class matrix3:
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    x: "struct vec3" = property(_obspython.matrix3_x_get, _obspython.matrix3_x_set, doc="x")
    y: "struct vec3" = property(_obspython.matrix3_y_get, _obspython.matrix3_y_set, doc="y")
    z: "struct vec3" = property(_obspython.matrix3_z_get, _obspython.matrix3_z_set, doc="z")
    t: "struct vec3" = property(_obspython.matrix3_t_get, _obspython.matrix3_t_set, doc="t")
...
class quat:
    ...
    ptr: float[4] = property(_obspython.quat_ptr_get, _obspython.quat_ptr_set, doc="ptr")
...
class obs_source_info:
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    id: "char const *" = property(_obspython.obs_source_info_id_get, _obspython.obs_source_info_id_set, doc="id")
    ...
    filter_video: "struct obs_source_frame *(*)(void *,struct obs_source_frame *)" = property(
        _obspython.obs_source_info_filter_video_get,
        _obspython.obs_source_info_filter_video_set,
        doc="filter_video",
    )
    filter_audio: "struct obs_audio_data *(*)(void *,struct obs_audio_data *)" = property(
...
def obs_property_set_modified_callback(p: "obs_property_t *", modified: obs_property_modified_t) -> void: ...
...
class obs_mouse_event:
    ...
    x: int32_t = property(_obspython.obs_mouse_event_x_get, _obspython.obs_mouse_event_x_set, doc="x")
    y: int32_t = property(_obspython.obs_mouse_event_y_get, _obspython.obs_mouse_event_y_set, doc="y")
...
class obs_key_event:
    ...
    text: "char *" = property(_obspython.obs_key_event_text_get, _obspython.obs_key_event_text_set, doc="text")
...
def obs_enum_sources(enum_proc: "bool (*)(void *,obs_source_t *)", param: "void *") -> void: ...
...
def obs_remove_tick_callback(tick: "void (*)(void *,float)", param: "void *") -> void: ...
def obs_add_main_render_callback(draw: "void (*)(void *,uint32_t,uint32_t)", param: "void *") -> void: ...
def obs_remove_main_render_callback(draw: "void (*)(void *,uint32_t,uint32_t)", param: "void *") -> void: ...
...
class calldata:
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    stack: "uint8_t *" = property(_obspython.calldata_stack_get, _obspython.calldata_stack_set, doc="stack")
    size: size_t = property(_obspython.calldata_size_get, _obspython.calldata_size_set, doc="size")
    capacity: size_t = property(
        _obspython.calldata_capacity_get,
        _obspython.calldata_capacity_set,
        doc="capacity",
    )
    fixed: bool = property(_obspython.calldata_fixed_get, _obspython.calldata_fixed_set, doc="fixed")
...
class os_dirent:
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    d_name: char[256] = property(_obspython.os_dirent_d_name_get, _obspython.os_dirent_d_name_set, doc="d_name")
...
class os_globent:
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    path: "char *" = property(_obspython.os_globent_path_get, _obspython.os_globent_path_set, doc="path")
    directory: bool = property(
...
def obs_frontend_add_dock_by_id(id: "char const *", title: "char const *", widget: "void *") -> bool: ...
def obs_frontend_remove_dock(id: "char const *") -> void: ...
def obs_frontend_add_custom_qdock(id: "char const *", dock: "void *") -> bool: ...
def obs_frontend_add_event_callback(callback: obs_frontend_event_cb, private_data: "void *") -> void: ...
def obs_frontend_remove_event_callback(callback: obs_frontend_event_cb, private_data: "void *") -> void: ...
def obs_frontend_add_save_callback(callback: obs_frontend_save_cb, private_data: "void *") -> void: ...
def obs_frontend_remove_save_callback(callback: obs_frontend_save_cb, private_data: "void *") -> void: ...
def obs_frontend_add_preload_callback(callback: obs_frontend_save_cb, private_data: "void *") -> void: ...
def obs_frontend_remove_preload_callback(callback: obs_frontend_save_cb, private_data: "void *") -> void: ...
