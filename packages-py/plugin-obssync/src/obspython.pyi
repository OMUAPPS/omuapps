...
if __package__ or "." in __name__:
    from .omuplugin_obssync import _obspython
else:
    import _obspython
...
class gs_monitor_info:
    ...
    rotation_degrees: int = property(
        ...
        doc=r"""rotation_degrees""",
    )
    x: long = property(
        _obspython.gs_monitor_info_x_get, _obspython.gs_monitor_info_x_set, doc=r"""x"""
    )
    y: long = property(
        _obspython.gs_monitor_info_y_get, _obspython.gs_monitor_info_y_set, doc=r"""y"""
    )
    cx: long = property(
        _obspython.gs_monitor_info_cx_get,
        _obspython.gs_monitor_info_cx_set,
        doc=r"""cx""",
    )
    cy: long = property(
        _obspython.gs_monitor_info_cy_get,
        _obspython.gs_monitor_info_cy_set,
        doc=r"""cy""",
    )
...
class gs_vb_data:
    ...
    __repr__ = _swig_repr
    num: size_t = property(
        _obspython.gs_vb_data_num_get, _obspython.gs_vb_data_num_set, doc=r"""num"""
    )
    points: "struct vec3 *" = property(
        _obspython.gs_vb_data_points_get,
        _obspython.gs_vb_data_points_set,
        doc=r"""points""",
    )
    ...
    colors: "uint32_t *" = property(
        _obspython.gs_vb_data_colors_get,
        _obspython.gs_vb_data_colors_set,
        doc=r"""colors""",
    )
...
class gs_rect:
    ...
    cx: int = property(
        _obspython.gs_rect_cx_get, _obspython.gs_rect_cx_set, doc=r"""cx"""
    )
    cy: int = property(
        _obspython.gs_rect_cy_get, _obspython.gs_rect_cy_set, doc=r"""cy"""
    )
...
class gs_init_data:
    ...
    cx: uint32_t = property(
        _obspython.gs_init_data_cx_get, _obspython.gs_init_data_cx_set, doc=r"""cx"""
    )
    cy: uint32_t = property(
        _obspython.gs_init_data_cy_get, _obspython.gs_init_data_cy_set, doc=r"""cy"""
    )
    num_backbuffers: uint32_t = property(
        _obspython.gs_init_data_num_backbuffers_get,
        _obspython.gs_init_data_num_backbuffers_set,
        doc=r"""num_backbuffers""",
    )
...
def gs_create_texture_file_data3(
    ...
    """
    return _obspython.gs_create_texture_file_data3(
        file, alpha_mode, format, cx, cy, space
    )
...
def gs_draw_cube_backdrop(
    ...
    """
    return _obspython.gs_draw_cube_backdrop(
        cubetex, rot, left, right, top, bottom, znear
    )
...
def gs_texture_create(
    ...
    """
    return _obspython.gs_texture_create(
...
def gs_voltexture_create(
    ...
    """
    return _obspython.gs_voltexture_create(
        width, height, depth, color_format, levels, data, flags
    )
...
def gs_copy_texture_region(
    ...
    """
    return _obspython.gs_copy_texture_region(
        dst, dst_x, dst_y, src, src_x, src_y, src_w, src_h
    )
...
class vec4:
    ...
    ptr: float[4] = property(
        _obspython.vec4_ptr_get, _obspython.vec4_ptr_set, doc=r"""ptr"""
    )
...
class vec3:
    ...
    ptr: float[4] = property(
        _obspython.vec3_ptr_get, _obspython.vec3_ptr_set, doc=r"""ptr"""
    )
...
class vec2:
    ...
    ptr: float[2] = property(
        _obspython.vec2_ptr_get, _obspython.vec2_ptr_set, doc=r"""ptr"""
    )
...
class matrix4:
    ...
    x: "struct vec4" = property(
        _obspython.matrix4_x_get, _obspython.matrix4_x_set, doc=r"""x"""
    )
    y: "struct vec4" = property(
        _obspython.matrix4_y_get, _obspython.matrix4_y_set, doc=r"""y"""
    )
    z: "struct vec4" = property(
        _obspython.matrix4_z_get, _obspython.matrix4_z_set, doc=r"""z"""
    )
    t: "struct vec4" = property(
        _obspython.matrix4_t_get, _obspython.matrix4_t_set, doc=r"""t"""
    )
...
class matrix3:
    ...
    x: "struct vec3" = property(
        _obspython.matrix3_x_get, _obspython.matrix3_x_set, doc=r"""x"""
    )
    y: "struct vec3" = property(
        _obspython.matrix3_y_get, _obspython.matrix3_y_set, doc=r"""y"""
    )
    z: "struct vec3" = property(
        _obspython.matrix3_z_get, _obspython.matrix3_z_set, doc=r"""z"""
    )
    t: "struct vec3" = property(
        _obspython.matrix3_t_get, _obspython.matrix3_t_set, doc=r"""t"""
    )
...
class quat:
    ...
    ptr: float[4] = property(
        _obspython.quat_ptr_get, _obspython.quat_ptr_set, doc=r"""ptr"""
    )
...
class obs_source_audio_mix:
    ...
    def __init__(self):
        ...
        _obspython.obs_source_audio_mix_swiginit(
            self, _obspython.new_obs_source_audio_mix()
        )
...
def obs_properties_add_int_slider(
    ...
    """
    return _obspython.obs_properties_add_int_slider(
...
def obs_properties_add_float_slider(
    ...
    """
    return _obspython.obs_properties_add_float_slider(
        props, name, description, min, max, step
    )
...
def obs_properties_add_path(
    ...
    """
    return _obspython.obs_properties_add_path(
        props, name, description, type, filter, default_path
    )
...
def obs_properties_add_editable_list(
    ...
    """
    return _obspython.obs_properties_add_editable_list(
        props, name, description, type, filter, default_path
    )
...
class obs_mouse_event:
    ...
    x: int32_t = property(
        _obspython.obs_mouse_event_x_get, _obspython.obs_mouse_event_x_set, doc=r"""x"""
    )
    y: int32_t = property(
        _obspython.obs_mouse_event_y_get, _obspython.obs_mouse_event_y_set, doc=r"""y"""
    )
...
class obs_key_event:
    ...
    text: "char *" = property(
        _obspython.obs_key_event_text_get,
        _obspython.obs_key_event_text_set,
        doc=r"""text""",
    )
...
class obs_key_combination:
    ...
    def __init__(self):
        ...
        _obspython.obs_key_combination_swiginit(
            self, _obspython.new_obs_key_combination()
        )
...
def obs_hotkeys_set_audio_hotkeys_translations(
    ...
    """
    return _obspython.obs_hotkeys_set_audio_hotkeys_translations(
        mute, unmute, push_to_mute, push_to_talk
    )
...
class obs_transform_info:
    ...
    crop_to_bounds: bool = property(
        ...
        doc=r"""crop_to_bounds""",
    )

    def __init__(self):
        r"""__init__(self) -> obs_transform_info"""
        _obspython.obs_transform_info_swiginit(
            self, _obspython.new_obs_transform_info()
        )
...
class obs_source_cea_708:
    ...
    def __init__(self):
        ...
        _obspython.obs_source_cea_708_swiginit(
            self, _obspython.new_obs_source_cea_708()
        )
...
def obs_module_get_locale_string(
    ...
    """
    return _obspython.obs_module_get_locale_string(
        mod, lookup_string, translated_string
    )
...
def obs_add_raw_video_callback2(
    ...
    """
    return _obspython.obs_add_raw_video_callback2(
        conversion, frame_rate_divisor, callback, param
    )
...
def obs_source_draw_set_color_matrix(
    ...
    """
    return _obspython.obs_source_draw_set_color_matrix(
...
def obs_source_process_filter_begin_with_color_space(
    ...
    """
    return _obspython.obs_source_process_filter_begin_with_color_space(
        filter, format, space, allow_direct
    )
...
def obs_source_process_filter_tech_end(
    ...
    """
    return _obspython.obs_source_process_filter_tech_end(
        filter, effect, width, height, tech_name
    )
...
def obs_source_send_mouse_click(
    ...
    """
    return _obspython.obs_source_send_mouse_click(
...
def obs_transition_video_render2(
    ...
    """
    return _obspython.obs_transition_video_render2(
...
def obs_transition_audio_render(
    ...
    """
    return _obspython.obs_transition_audio_render(
        transition,
        ts_out,
        audio,
        mixers,
...
class obs_sceneitem_order_info:
    ...
    def __init__(self):
        ...
        _obspython.obs_sceneitem_order_info_swiginit(
            self, _obspython.new_obs_sceneitem_order_info()
        )
...
class obs_sceneitem_crop:
    ...
    def __init__(self):
        ...
        _obspython.obs_sceneitem_crop_swiginit(
            self, _obspython.new_obs_sceneitem_crop()
        )
...
def obs_audio_encoder_create(
    ...
    """
    return _obspython.obs_audio_encoder_create(
        id, name, settings, mixer_idx, hotkey_data
    )
...
def obs_service_apply_encoder_settings(
    ...
    """
    return _obspython.obs_service_apply_encoder_settings(
        service, video_encoder_settings, audio_encoder_settings
    )
...
class calldata:
    ...
    stack: "uint8_t *" = property(
        _obspython.calldata_stack_get, _obspython.calldata_stack_set, doc=r"""stack"""
    )
    size: size_t = property(
        _obspython.calldata_size_get, _obspython.calldata_size_set, doc=r"""size"""
    )
    ...
    fixed: bool = property(
        _obspython.calldata_fixed_get, _obspython.calldata_fixed_set, doc=r"""fixed"""
    )
...
def os_quick_write_utf8_file_safe(
    ...
    """
    return _obspython.os_quick_write_utf8_file_safe(
        path, str, len, marker, temp_ext, backup_ext
    )
...
class os_dirent:
    ...
    d_name: char[256] = property(
        _obspython.os_dirent_d_name_get,
        _obspython.os_dirent_d_name_set,
        doc=r"""d_name""",
    )
...
class os_globent:
    ...
    __repr__ = _swig_repr
    path: "char *" = property(
        _obspython.os_globent_path_get, _obspython.os_globent_path_set, doc=r"""path"""
    )
    directory: bool = property(
...
class os_proc_memory_usage:
    ...
    def __init__(self):
        ...
        _obspython.os_proc_memory_usage_swiginit(
            self, _obspython.new_os_proc_memory_usage()
        )
...
def obs_frontend_add_undo_redo_action(
    ...
    """
    return _obspython.obs_frontend_add_undo_redo_action(
