import { createI18n, createI18nUnion, loadI18n, type I18n, type TranslateFunction } from './i18n';

export { createI18n, createI18nUnion, I18n, TranslateFunction };
...
const i18nSubscribers: Subscriber<I18n>[] = [];

export const i18n: Writable<I18n> = {
    value: LOCALES[SYSTEM_LANGUAGE].i18n,
    subscribe(run: Subscriber<I18n>): Unsubscriber {
    ...
    set(newI18n: I18n): void {
        i18n.value = newI18n;
        for (const subscriber of i18nSubscribers) {
            subscriber(newI18n);
        }
    },
    update(updater: Updater<I18n>): void {
