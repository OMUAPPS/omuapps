export {
    ...
    DASHOBARD_APP_READ_PERMISSION_ID, GetCookiesRequest, HostRequest, UserResponse, WebviewPacket, WebviewRequest, type SpeechRecognitionStart, type TranscriptSegment, type TranscriptStatus,
    type WebviewEvent,
} from './extension.js';
