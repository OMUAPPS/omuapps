...
export const PALETTE_RGB = {
    ...
    BACKGROUND_1_TRANSPARENT: new Vec4(246 / 255, 242 / 255, 235 / 255, 0.8),
    BACKGROUND_2: new Vec4(255 / 255, 254 / 255, 252 / 255, 1.0),
    BACKGROUND_2_TRANSPARENT: new Vec4(255 / 255, 254 / 255, 252 / 255, 0.8),
    BACKGROUND_3: new Vec4(0, 0, 0, 0.1),
