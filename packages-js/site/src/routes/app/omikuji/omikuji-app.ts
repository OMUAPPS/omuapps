...
export const DEFAULT_CONFIG: Config = {
    active: false,
    patterns: [
        { name: '大吉', description: '素晴らしい一年になるでしょう。でも油断は禁物です。' },
        { name: '中吉', description: '良い運勢です。努力が実を結ぶでしょう。' },
        { name: '小吉', description: '慎重に行動すれば、良い結果が得られます。' },
        { name: '吉', description: '焦らずに進めば、幸運が訪れます。' },
        { name: '末吉', description: '運勢は安定しています。日々の努力を続けましょう。' },
        { name: '凶', description: '注意が必要です。無理をせず、冷静に対処しましょう。' },
        { name: '大凶', description: '困難な時期ですが、周囲の助けを借りれば乗り越えられます。' },
    ],
};
